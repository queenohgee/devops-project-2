...
pipeline {
    ...
    stage('SonarQube Scan') {
      steps {
        sh """mvn sonar:sonar \
              ...
              -Dsonar.host.url=http://172.31.8.6:9000 \
              -Dsonar.login=de371a93c51be11398dcd0507c3fbd6683714efe"""
      }
    }
  ...
  post {
    always {
        ...
        slackSend channel: '#gbemmy-jenkins-cicd-pipeline-alerts', //update and provide your channel name
